...
window.addEventListener('scroll', function () {
    ...
    if (window.scrollY > 50) {
        // navbar.style.backgroundColor = 'rgba(255, 255, 255, 0.98)'; // Removido para manter cor do CSS
        navbar.style.boxShadow = '0 5px 20px rgba(0, 0, 0, 0.3)';
        navbar.style.padding = '1.3rem 0';
    } else {
        // navbar.style.backgroundColor = 'rgba(255, 255, 255, 0.8)'; // Removido para manter cor do CSS
